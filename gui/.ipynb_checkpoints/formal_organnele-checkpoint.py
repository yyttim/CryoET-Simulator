...
# 蛋白质开启扰动开关
PROTEINS_LIST_DISTRIBUTED = []
# 是否开启单簇模式
PROTEINS_LIST_SINGLE_MODE = []
# 0：随机 1：高斯分布 2：梯度分布 3：对数正态分布 4：密度可调的均匀分布, 5:指定范围数量
PROTEINS_LIST_METHOD      = []
# 配合模式4 密度模式，指定个体数量
PROTEINS_LIST_DENSITY_LOOP = []
# 配合模式5 指定个体数量
PROTEINS_LIST_POS_LOOP = []
MB_PROTEINS_LIST = []
ORGANELLE_LIST = [
...
malign_mx_widget = 0
malign_sg_widget = 0
detector_snr_widget_low = 1e6
detector_snr_widget_high = 1e6
widget_min = -60
widget_max = 61
widget_paso = 2
