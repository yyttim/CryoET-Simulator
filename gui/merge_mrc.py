...
mrc_file_a = '../data/organelles/mitochondria/UE3-100-mitochondrial_outer_membrane-1.0_segmentationmask.mrc'
mrc_file_b = '../data/organelles/mitochondria/UE3-101-mitochondrial_inner_membrane-1.0_segmentationmask.mrc'
...
output_filename = os.path.join(os.path.dirname(mrc_file_a), 'UE3-100-merged_file.mrc')
